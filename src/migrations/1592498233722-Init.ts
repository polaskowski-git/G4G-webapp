...
export class Init1592498233722 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `users_achievments_achievements` (`usersId` int UNSIGNED NOT NULL, `achievementsId` int UNSIGNED NOT NULL, INDEX `IDX_81957c31576d4f197cd0ba1a2f` (`usersId`), INDEX `IDX_8e1deb8be9261f2b186ecdd9e9` (`achievementsId`), PRIMARY KEY (`usersId`, `achievementsId`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `users_achievments_achievements` ADD CONSTRAINT `FK_81957c31576d4f197cd0ba1a2f0` FOREIGN KEY (`usersId`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `users_achievments_achievements` ADD CONSTRAINT `FK_8e1deb8be9261f2b186ecdd9e9a` FOREIGN KEY (`achievementsId`) REFERENCES `achievements`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `users_achievments_achievements` DROP FOREIGN KEY `FK_8e1deb8be9261f2b186ecdd9e9a`");
        await queryRunner.query("ALTER TABLE `users_achievments_achievements` DROP FOREIGN KEY `FK_81957c31576d4f197cd0ba1a2f0`");
        ...
        await queryRunner.query("DROP INDEX `IDX_8e1deb8be9261f2b186ecdd9e9` ON `users_achievments_achievements`");
        await queryRunner.query("DROP INDEX `IDX_81957c31576d4f197cd0ba1a2f` ON `users_achievments_achievements`");
        await queryRunner.query("DROP TABLE `users_achievments_achievements`");
